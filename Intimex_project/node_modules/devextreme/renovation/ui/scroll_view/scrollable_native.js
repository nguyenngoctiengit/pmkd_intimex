/**
 * DevExtreme (renovation/ui/scroll_view/scrollable_native.js)
 * Version: 21.1.3
...
var ScrollableNative = function(_InfernoComponent) {
    ...
    _proto.set_needForceScrollbarsVisibility = function(value) {
        var _this6 = this;
        this.setState((function(state) {
    ...
    _proto.set_pullDownTranslateTop = function(value) {
        var _this9 = this;
        this.setState((function(state) {
    ...
    _proto.set_pullDownIconAngle = function(value) {
        var _this10 = this;
        this.setState((function(state) {
    ...
    _proto.set_pullDownOpacity = function(value) {
        var _this11 = this;
        this.setState((function(state) {
    ...
    _proto.set_topPocketTop = function(value) {
        var _this12 = this;
        this.setState((function(state) {
    ...
    _proto.set_contentTranslateTop = function(value) {
        var _this13 = this;
        this.setState((function(state) {
    ...
    _proto.disposeReleaseTimeout = function() {
        var _this16 = this;
        return function() {
    ...
    _proto.disposeHideScrollbarTimeout = function() {
        var _this18 = this;
        return function() {
    ...
    _proto.disposeRefreshTimeout = function() {
        var _this23 = this;
        return function() {
            return _this23.clearRefreshTimeout()
        }
    };
    _proto.clearReleaseTimeout = function() {
    ...
    _proto.handleScroll = function(e) {
    ...
    _proto.clearHideScrollbarTimeout = function() {
    ...
    _proto.handleInit = function(e) {
        if (this.props.forceGeneratePockets && this.isSwipeDownStrategy) {
            if (this.topPocketState === _consts.TopPocketState.STATE_RELEASED && 0 === this.scrollLocation().top) {
    ...
    _proto.clearRefreshTimeout = function() {
    ...
    _proto.isScrollingOutOfBound = function(e) {
        var delta = e.delta,
            shiftKey = e.shiftKey;
    ...
    _createClass(ScrollableNative, [{
        ...
        get: function() {
            var _this$props6 = this.props,
                restProps = (_this$props6.aria, _this$props6.bounceEnabled, _this$props6.children, _this$props6.classes, _this$props6.direction, _this$props6.disabled, _this$props6.forceGeneratePockets, _this$props6.height, _this$props6.needScrollViewContentWrapper, _this$props6.needScrollViewLoadPanel, _this$props6.onKeyDown, _this$props6.onPullDown, _this$props6.onReachBottom, _this$props6.onScroll, _this$props6.onUpdated, _this$props6.pullDownEnabled, _this$props6.pulledDownText, _this$props6.pullingDownText, _this$props6.reachBottomEnabled, _this$props6.reachBottomText, _this$props6.refreshingText, _this$props6.rtlEnabled, _this$props6.scrollByContent, _this$props6.scrollByThumb, _this$props6.showScrollbar, _this$props6.updateManually, _this$props6.useNative, _this$props6.useSimulatedScrollbar, _this$props6.visible, _this$props6.width, _objectWithoutProperties(_this$props6, ["aria", "bounceEnabled", "children", "classes", "direction", "disabled", "forceGeneratePockets", "height", "needScrollViewContentWrapper", "needScrollViewLoadPanel", "onKeyDown", "onPullDown", "onReachBottom", "onScroll", "onUpdated", "pullDownEnabled", "pulledDownText", "pullingDownText", "reachBottomEnabled", "reachBottomText", "refreshingText", "rtlEnabled", "scrollByContent", "scrollByThumb", "showScrollbar", "updateManually", "useNative", "useSimulatedScrollbar", "visible", "width"]));
            return restProps
        }
    }]);
