    ...
    _createClass(GroupPanelVerticalCell, [{
        ...
        get: function() {
            var _this$props = this.props,
                restProps = (_this$props.cellTemplate, _this$props.className, _this$props.color, _this$props.data, _this$props.id, _this$props.index, _this$props.text, _objectWithoutProperties(_this$props, ["cellTemplate", "className", "color", "data", "id", "index", "text"]));
            return restProps
        }
    }]);
