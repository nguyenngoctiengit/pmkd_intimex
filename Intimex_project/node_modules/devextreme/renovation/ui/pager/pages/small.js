...
var PagesSmall = function(_InfernoComponent) {
    ...
    _proto.set_pageIndex = function(value) {
        ...
        this.setState((function(state) {
            ...
            var newValue = value();
            null === (_this3$props$pageInde = (_this3$props = _this3.props).pageIndexChange) || void 0 === _this3$props$pageInde ? void 0 : _this3$props$pageInde.call(_this3$props, newValue);
    ...
    _createClass(PagesSmall, [{
        ...
        get: function() {
            var _this$props$pageIndex2 = _extends({}, this.props, {
                ...
                restProps = (_this$props$pageIndex2.defaultPageIndex, _this$props$pageIndex2.pageCount, _this$props$pageIndex2.pageIndex, _this$props$pageIndex2.pageIndexChange, _this$props$pageIndex2.pagesCountText, _objectWithoutProperties(_this$props$pageIndex2, ["defaultPageIndex", "pageCount", "pageIndex", "pageIndexChange", "pagesCountText"]));
            return restProps
        }
    }]);
    return PagesSmall
