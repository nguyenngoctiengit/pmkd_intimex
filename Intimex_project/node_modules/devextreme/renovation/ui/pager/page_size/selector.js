    ...
    _createClass(PageSizeSelector, [{
        ...
        get: function() {
            var _this$props$pageSize = _extends({}, this.props, {
                ...
                restProps = (_this$props$pageSize.defaultPageSize, _this$props$pageSize.isLargeDisplayMode, _this$props$pageSize.pageSize, _this$props$pageSize.pageSizeChange, _this$props$pageSize.pageSizes, _this$props$pageSize.rootElementRef, _objectWithoutProperties(_this$props$pageSize, _excluded));
            return restProps
        }
    }]);
