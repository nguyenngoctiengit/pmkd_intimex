...
if (_devextremeQuill.default) {
    ...
    ToolbarModule = function(_BaseModule) {
        ...
        _proto._getDefaultClickHandler = function(name) {
            var _this2 = this;
        ...
        _proto._prepareShortcutHandler = function(name, shortcutValue) {
            var _this4 = this;
        ...
        _proto._prepareColorClickHandler = function(name) {
            var _this12 = this;
            return function() {
                var formData = _this12.quill.getFormat();
                var caption = "color" === name ? DIALOG_COLOR_CAPTION : DIALOG_BACKGROUND_CAPTION;
                _this12.editorInstance.formDialogOption("title", _message.default.format(caption));
