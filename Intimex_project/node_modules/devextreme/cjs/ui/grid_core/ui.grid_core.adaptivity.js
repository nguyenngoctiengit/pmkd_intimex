    ...
    extenders: {
        ...
        controllers: {
            ...
            data: {
                ...
                toggleExpandAdaptiveDetailRow: function(key, alwaysExpanded) {
                    var oldExpandLoadedRowIndex = _uiGrid_core2.default.getIndexByKey(this._adaptiveExpandedKey, this._items);
                    var newExpandLoadedRowIndex = _uiGrid_core2.default.getIndexByKey(key, this._items);
            ...
            keyboardNavigation: {
                ...
                _processNextCellInMasterDetail: function($nextCell) {
                    ...
                    if (!this._isInsideEditForm($nextCell) && $nextCell && isCellOrBatchMode) {
                        _events_engine.default.on($nextCell, "focus", (function focusHandler() {
