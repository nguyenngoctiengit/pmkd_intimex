...
var ResizingController = _uiGrid_core.default.ViewController.inherit({
    ...
    _synchronizeColumns: function() {
        ...
        if ($element && $element[0] && this._maxWidth) {
            ...
            if (needBestFit) {
                resultWidths = _this2._getBestFitWidths();
                (0, _iterator.each)(visibleColumns, (function(index, column) {
                    var columnId = columnsController.getColumnId(column);
            ...
            if (resetBestFitMode) {
                _this2._toggleBestFitMode(false);
            ...
            isColumnWidthsCorrected = _this2._correctColumnWidths(resultWidths, visibleColumns);
            if (columnAutoWidth) {
                ! function() {
                ...
                if (_this2._needStretch()) {
                    _this2._processStretch(resultWidths, visibleColumns)
                }
            }(0, _common.deferRender)((function() {
                if (needBestFit || isColumnWidthsCorrected) {
                    _this2._setVisibleWidths(visibleColumns, resultWidths)
                }
            }))
        }))
    },
    ...
    _setScrollerSpacing: function(hasHeight) {
        ...
        if (true === this.option("scrolling.useNative")) {
            (0, _common.deferRender)((function() {
                (0, _common.deferUpdate)((function() {
                    _this3._setScrollerSpacingCore(hasHeight)
                }))
            }))
        } else {
