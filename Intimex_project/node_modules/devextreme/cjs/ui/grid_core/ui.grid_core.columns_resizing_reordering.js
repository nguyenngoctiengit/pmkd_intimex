    ...
    _startResizing: function(args) {
        ...
        if (that._isReadyResizing) {
            ...
            if (scrollable && that._isRtlParentStyle()) {
                that._scrollRight = scrollable.$content().width() - (0, _renderer.default)(scrollable.container()).width() - scrollable.scrollLeft()
            }
            e.preventDefault();
            e.stopPropagation()
        }
        ...
        if (needUpdate) {
            ...
            if (!isNextColumnMode) {
                ...
                if (scrollable && isRtlParentStyle) {
                    var left = scrollable.$content().width() - (0, _renderer.default)(scrollable.container()).width() - this._scrollRight;
                    scrollable.scrollTo({
                        left: left
                    })
                }
