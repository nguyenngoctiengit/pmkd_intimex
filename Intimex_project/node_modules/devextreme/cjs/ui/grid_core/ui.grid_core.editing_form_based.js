            ...
            editing: {
                ...
                _getPopupEditFormTemplate: function(rowIndex) {
                    ...
                    return function(container) {
                        ...
                        formTemplate(_this2._$popupContent, templateOptions, true)
                    }
                },
                ...
                optionChanged: function(args) {
                    if ("editing" === args.name && this.isFormOrPopupEditMode()) {
                        ...
                        if (0 === (null === fullName || void 0 === fullName ? void 0 : fullName.indexOf(_uiGrid_core.EDITING_POPUP_OPTION_NAME))) {
                            if (editPopup) {
                                var popupOptionName = fullName.slice(_uiGrid_core.EDITING_POPUP_OPTION_NAME.length + 1);
                                if (popupOptionName) {
                ...
                getFormEditorTemplate: function(cellOptions, item) {
                    ...
                    return function(options, container) {
                        ...
                        null === (_cellOptions$row$watc = (_cellOptions$row = cellOptions.row).watch) || void 0 === _cellOptions$row$watc ? void 0 : _cellOptions$row$watc.call(_cellOptions$row, (function() {
                            ...
                            cellOptions = _this4.renderFormEditTemplate.bind(_this4)(cellOptions, item, options.component, $container);
                ...
                _beforeEndSaving: function() {
                    ...
                    if (this.isPopupEditMode()) {
                        ...
                        null === (_this$_editPopup4 = this._editPopup) || void 0 === _this$_editPopup4 ? void 0 : _this$_editPopup4.hide()
                    }
                },
