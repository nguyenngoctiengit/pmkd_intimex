...
var KeyboardNavigationController = _uiGrid_core.default.ViewController.inherit({
    ...
    _pageUpDownKeyHandler: function(eventArgs) {
        ...
        } else if (scrollable && (0, _renderer.default)(scrollable.container()).height() < scrollable.$content().height()) {
            this._scrollBy(0, (0, _renderer.default)(scrollable.container()).height() * pageStep);
            eventArgs.originalEvent.preventDefault()
        }
    },
    ...
    _isCellValid: function($cell, isClick) {
        if (isElementDefined($cell)) {
            ...
            if (visibleColumnCount > columnIndex && (!isMasterDetailRow && column && (!(0, _type.isDefined)(column.groupIndex) || isShowWhenGrouped && isDataCell) || parseInt($cell.attr("colspan")) > 1)) {
