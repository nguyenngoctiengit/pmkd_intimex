 ...
 */
"use strict";
exports.renderFieldItemTo = renderFieldItemTo;
exports.LABEL_HORIZONTAL_ALIGNMENT_CLASS = exports.LABEL_VERTICAL_ALIGNMENT_CLASS = exports.FIELD_ITEM_HELP_TEXT_CLASS = exports.FIELD_ITEM_LABEL_ALIGN_CLASS = exports.FIELD_ITEM_CONTENT_LOCATION_CLASS = exports.FIELD_ITEM_CONTENT_WRAPPER_CLASS = exports.FIELD_ITEM_REQUIRED_CLASS = exports.FIELD_ITEM_OPTIONAL_CLASS = exports.FLEX_LAYOUT_CLASS = void 0;
...
function renderFieldItemTo(_ref) {
    ...
    $container.addClass(containerCssClass).addClass((0, _type.isDefined)(item.col) ? "dx-col-" + item.col : "");
    ...
    if (validationTargetInstance) {
        ...
        if ((0, _themes.isMaterial)()) {
            ...
            var toggleInvalidClass = function(e) {
                (0, _renderer.default)(e.element).parents(wrapperClass).toggleClass(INVALID_CLASS, false === e.component.option("isValid") && (e.component._isFocused() || "always" === e.component.option("validationMessageMode")))
            };
