/**
 * DevExtreme (cjs/ui/pivot_grid/xmla_store/xmla_store.js)
 * Version: 21.1.3
...
var XmlaStore = _class.default.inherit(function() {
    ...
    function preparePathValue(pathValue, dataField) {
        if (pathValue) {
            pathValue = (0, _type.isString)(pathValue) && -1 !== pathValue.indexOf("&") ? pathValue : "[" + pathValue + "]";
    ...
    function getVisibleChildren(item, visibleLevels) {
        ...
        if (firstChild && (visibleLevels[firstChild.hierarchyName] && -1 !== (0, _array.inArray)(firstChild.levelName, visibleLevels[firstChild.hierarchyName]) || !visibleLevels[firstChild.hierarchyName] || 0 === firstChild.level)) {
