...
var removeExtraAttrs = function(html) {
    ...
    return html.replace(/(?:(<[a-z0-9]+\s*))([\s\S]*?)(>|\/>)/gi, (function(_, p1, p2, p3) {
        var _p;
...
var getGraphicExtraProps = function(props, x, y) {
    return {
