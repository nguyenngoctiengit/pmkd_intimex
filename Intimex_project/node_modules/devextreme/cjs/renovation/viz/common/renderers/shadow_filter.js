    ...
    _createClass(ShadowFilter, [{
        ...
        get: function() {
            var _this$props = this.props,
                restProps = (_this$props.blur, _this$props.color, _this$props.height, _this$props.id, _this$props.offsetX, _this$props.offsetY, _this$props.opacity, _this$props.width, _this$props.x, _this$props.y, _objectWithoutProperties(_this$props, ["blur", "color", "height", "id", "offsetX", "offsetY", "opacity", "width", "x", "y"]));
            return restProps
        }
    }]);
    return ShadowFilter
