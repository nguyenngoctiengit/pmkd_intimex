...
var PageSizeSelector = function(_InfernoComponent) {
    ...
    _proto.set_pageSize = function(value) {
        ...
        this.setState((function(state) {
            ...
            var newValue = value();
            null === (_this2$props$pageSize = (_this2$props = _this2.props).pageSizeChange) || void 0 === _this2$props$pageSize ? void 0 : _this2$props$pageSize.call(_this2$props, newValue);
    ...
    _createClass(PageSizeSelector, [{
        ...
        get: function() {
            var _this$props$pageSize = _extends({}, this.props, {
                ...
                restProps = (_this$props$pageSize.defaultPageSize, _this$props$pageSize.isLargeDisplayMode, _this$props$pageSize.pageSize, _this$props$pageSize.pageSizeChange, _this$props$pageSize.pageSizes, _this$props$pageSize.rootElementRef, _objectWithoutProperties(_this$props$pageSize, ["defaultPageSize", "isLargeDisplayMode", "pageSize", "pageSizeChange", "pageSizes", "rootElementRef"]));
            return restProps
        }
    }]);
