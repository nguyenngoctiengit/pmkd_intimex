/**
 * DevExtreme (cjs/exporter/jspdf/export_data_grid_row_info.js)
 * Version: 21.1.6
...
function _createCellInfo(_ref2) {
    ...
    if ("header" === rowInfo.rowType) {
        ...
        if ((0, _type.isDefined)(null === (_rowOptions$headerSty = rowOptions.headerStyles) || void 0 === _rowOptions$headerSty ? void 0 : _rowOptions$headerSty.backgroundColor)) {
        ...
        if ((0, _type.isDefined)(null === (_rowOptions$groupStyl = rowOptions.groupStyles) || void 0 === _rowOptions$groupStyl ? void 0 : _rowOptions$groupStyl.backgroundColor)) {
        ...
        if ((0, _type.isDefined)(null === (_rowOptions$totalStyl = rowOptions.totalStyles) || void 0 === _rowOptions$totalStyl ? void 0 : _rowOptions$totalStyl.backgroundColor)) {
