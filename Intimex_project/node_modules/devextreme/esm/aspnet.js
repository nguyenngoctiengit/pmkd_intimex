...
! function(factory) {
...
}((function($, _setTemplateEngine, templateRendered, Guid, validationEngine, iteratorUtils, extractTemplateMarkup, encodeHtml, ajax, console) {
    var templateCompiler = function() {
        ...
        return function(text) {
            var bag = ["var _ = [];", "with(obj||{}) {"],
                chunks = text.split(_enableAlternativeTemplateTags ? EXTENDED_OPEN_TAG : "<%");
            if (_warnBug && chunks.length > 1) {
                if (text.indexOf("<%") > -1) {
            ...
            for (var i = 0; i < chunks.length; i++) {
                var tmp = chunks[i].split(_enableAlternativeTemplateTags ? EXTENDED_CLOSE_TAG : "%>");
                if (2 !== tmp.length) {
    ...
    var _enableAlternativeTemplateTags = true;
    var _warnBug = false;
    ...
    return {
        ...
        enableAlternativeTemplateTags: function(value) {
            _enableAlternativeTemplateTags = value
        },
