...
export function getCanvas(container) {
    ...
    var left = (null === (_getWindow = getWindow()) || void 0 === _getWindow ? void 0 : _getWindow.pageXOffset) || html.scrollLeft || 0;
    var top = (null === (_getWindow2 = getWindow()) || void 0 === _getWindow2 ? void 0 : _getWindow2.pageYOffset) || html.scrollTop || 0;
    var box = {
        left: left,
        top: top,
