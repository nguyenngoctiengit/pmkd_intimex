...
export function drawPdfTable(doc, styles, table, options) {
    ...
    var {
        allowDrawBorders: allowDrawBorders,
        allowDrawCustomBorders: allowDrawCustomBorders,
        allowDrawCellContent: allowDrawCellContent
    } = null !== options && void 0 !== options ? options : {};
    ...
    function drawRow(rowCells) {
        ...
        rowCells.forEach(cell => {
            ...
            if (true === allowDrawCellContent) {
                ...
                if (font.name !== docFont.fontName || font.style !== docFont.fontStyle || isDefined(font.weight)) {
            ...
            var isDrawBorders = isDefined(cell.borderColor) ? true === allowDrawCustomBorders : true === allowDrawBorders;
            if (isDrawBorders) {
    ...
    if (true === allowDrawBorders && (isDefined(table.drawTableBorder) ? table.drawTableBorder : isDefined(table.rows) && 0 === table.rows.length)) {
