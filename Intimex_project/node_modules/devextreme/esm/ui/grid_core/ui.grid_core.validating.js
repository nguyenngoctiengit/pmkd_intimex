        ...
        controllers: {
            editing: {
                ...
                _needInsertItem: function(change) {
                    ...
                    var validationData = this.getController("validating")._getValidationData(key);
                    if (result && !(null !== validationData && void 0 !== validationData && validationData.isValid) && "virtual" !== this.option("scrolling.mode")) {
                ...
                processItems: function(items, changeType) {
                    ...
                    if (that.getEditMode() === EDIT_MODE_BATCH && "prepend" !== changeType && "append" !== changeType) {
                        changes.forEach(change => {
                            ...
                            if (validationData && change.type && validationData.pageIndex === that._pageIndex && (null === change || void 0 === change ? void 0 : change.pageIndex) !== that._pageIndex) {
