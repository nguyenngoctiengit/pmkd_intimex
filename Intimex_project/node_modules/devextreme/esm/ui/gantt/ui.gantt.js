...
class Gantt extends Widget {
    ...
    _dataSourceChanged(dataSourceName, data) {
        ...
        if (dataSourceName === GANTT_TASKS) {
            ...
            var forceUpdate = !(null !== (_this$_ganttTreeList2 = this._ganttTreeList) && void 0 !== _this$_ganttTreeList2 && _this$_ganttTreeList2.getDataSource()) && !this._ganttView;
    ...
    _onParentTasksRecalculated(data) {
        ...
        null === (_this$_ganttTreeList4 = this._ganttTreeList) || void 0 === _this$_ganttTreeList4 ? void 0 : _this$_ganttTreeList4.setOption("dataSource", treeDataSource)
    }
    _getToolbarItems() {
    ...
    exportToPdf(options) {
        ...
        return new Promise(resolve => {
            ...
            var doc = null === (_this$_ganttView3 = this._ganttView) || void 0 === _this$_ganttView3 ? void 0 : _this$_ganttView3._ganttViewCore.exportToPdf(fullOptions);
            resolve(doc)
        })
    }
    _getDefaultOptions() {
