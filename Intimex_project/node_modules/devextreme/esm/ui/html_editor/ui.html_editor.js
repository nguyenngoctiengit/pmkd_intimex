...
var HtmlEditor = Editor.inherit({
    ...
    _tableResizingOptionChanged: function(args) {
        ...
        var tableResizingModule = null === (_this$_quillInstance = this._quillInstance) || void 0 === _this$_quillInstance ? void 0 : _this$_quillInstance.getModule("tableResizing");
        var shouldPassOptionsToModule = Boolean(tableResizingModule);
