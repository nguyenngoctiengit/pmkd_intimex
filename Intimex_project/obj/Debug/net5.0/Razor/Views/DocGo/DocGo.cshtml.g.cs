#pragma checksum "C:\Users\User\Desktop\project_intimex\Intimex_project\Views\DocGo\DocGo.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5a80541020bfa86149390bf8f3f8f7158474ad79"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5a80541020bfa86149390bf8f3f8f7158474ad79", @"/Views/DocGo/DocGo.cshtml")]
...
#nullable disable
            ...
            WriteLiteral(@"                     <div class=""modal-dialog"" role=""document"">
                                    ...
                                    <input type=""text"" id=""DocIdSelected"" hidden>
                                </div>
                            </div>
                        </div>
                    </div>
                ");
            WriteLiteral("</div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5a80541020bfa86149390bf8f3f8f7158474ad7917258", async() => {
            }
            );
...
<script>
    ...
    function Change_DocId(selectedItems) {
        ...
        if (data) {
            document.getElementById(""DocIdSelected"").value = data.DocId;
        }
    }
   ...
   ");
            WriteLiteral(@" function toolbar_DocGo(e) {
        ...
        e.toolbarOptions.items.unshift({
            ...
            options: {
                icon: ""edit"",
                onClick: function () {
                    var id = document.getElementById(""DocIdSelected"").value;
                    if (id) {
                        $.post('/DocGo/EditDocGo', { 'id': id }, function (response) {
                            $(""#_PartiView_AddOrUpdate_Archive"").html(response);
                            $(""#myModa");
            ...
            options: {
                ...
                onClick: function () {
                    ...
                    if (id) {
                        ...
                        $.notify(""please choose the document you wa");
            WriteLiteral(@"nt to save!"", ""error"");
                    }
                },
            }
        ...
        e.toolbarOptions.items.unshift({
            ...
            options: {
                ...
                onClick: function () {
                    var id = document.getElementById(""DocIdSelected"").value;
                    if (id) {
                        $.post('/doccome/DocTransfer', { 'id': id }, function (response) {
                            console.log(id);
                            $(""#_PartiView_AddOrUpdate_Archive"").html(response);
                            document.getElementById(""Form_DocTranfer"").action = ""/DocCome/Doc_Transfer/"" + id;
                            $(""#myModal"").modal(""show"");
                        })
                    }
                    else {
