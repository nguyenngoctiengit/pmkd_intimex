#pragma checksum "C:\Users\Sterben\Desktop\pmkd_intimex\Intimex_project\Views\Plans\AddPlans.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4ad616001eb5170f68c50bd1ee24dc82bc0ed2f2"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4ad616001eb5170f68c50bd1ee24dc82bc0ed2f2", @"/Views/Plans/AddPlans.cshtml")]
...
#nullable disable
            ...
            WriteLiteral("                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4ad616001eb5170f68c50bd1ee24dc82bc0ed2f28350", async() => {
                WriteLiteral(@"
                    <hr size=""3"">
                    <div class=""form-group row"" style=""margin-bottom:0px"">
                    ...
                    <div class=""form-group row"" style=""margin-bottom:0px"">
                        ...
                        <input type=""text"" class=""form-control col-md-4 col-sm-4 text-box-hdmb"" id=""txtSoHD_BAN"" onclick=""txtSoHD_BAN_Click()"" name=""txtSoHD_BAN"">
                    ...
                    <div class=""form-group row"" style=""margin-bottom:0px"">
                        ...
                        <input type=""");
                WriteLiteral(@"text"" class=""form-control col-md-4 col-sm-4 text-box-hdmb"" id=""txtTrongLuongHD_BAN"" name=""txtTrongLuongHD_BAN"">
                ...
                WriteLiteral("l\">HĐ hoàn thành ghép</label>\r\n                    </div>\r\n");
                WriteLiteral(@"                    <hr size=""3"">
                    ...
                    <div class=""form-group row"" style=""margin-bottom:0px"">
                        <label class=""col-form-label col-md-2 col-sm-2"">Số HĐ</label>
                        <input type=""text"" class=""form-control col-md-4 col-sm-4 text-box-hdmb"" id=""txtSoHD_MUA"" onclick=""txtSoHD_MUA_Click()"" name=""txtSoHD_MUA"">
                        <label class=""col-form-label col-md-2 col-sm-2"">ID HĐ</label>
                    ...
                    <div class=""form-group row"" style=""margin-bottom:0px"">
                        <label class=""col-form-label col-md-2 col-sm-2"">Trọng lượng HĐ</label>
                        <input type=""te");
                WriteLiteral(@"xt"" class=""form-control col-md-4 col-sm-4 text-box-hdmb"" id=""txtTrongLuongHD_MUA"" name=""txtTrongLuongHD_MUA"">
                        <label class=""col-form-label col-md-2 col-sm-2"">ĐVT</label>
                ...
                WriteLiteral(">HĐ hoàn thành ghép</label>\r\n                    </div>\r\n                ");
            }
            );
...
#nullable restore
#line 237 "C:\Users\Sterben\Desktop\pmkd_intimex\Intimex_project\Views\Plans\AddPlans.cshtml"
        Write(Html.DevExtreme().DataGrid()
                                    ...
                                    columns.Add().DataField("TrongluongHD");
                                    columns.Add().DataField("TrongLuongDuocGhep");
                                    })
                                    .OnSelectionChanged("SelectedHDMB")
                                    .HoverStateEnabled(true)
                                    .Paging(p => p.PageSize(10))
                                    .FilterRow(f => f.Visible(true))
                                    .Selection(s => s.Mode(SelectionMode.Single))
...
#nullable disable
            WriteLiteral(@"
            <div class=""modal-footer"">
                <button type=""button"" class=""btn btn-secondary"" onclick=""close_Popup_GetHDMB()"">Selected</button>
            </div>
        </div>
    </div>
</div>
<input type=""text"" id=""check_SelectedMuaBan"" hidden>
");
            WriteLiteral(@"<script>
    ...
    function Disable_HDBan() {
        document.getElementById(""txtSoHD_BAN"").readOnly   = true;
        document.getElementById(""txtIdHD_BAN"").readOnly   = true;
        document.getElementById(""txtTrongLuongHD_BAN"").readOnly   = true;
        document.ge");
            WriteLiteral(@"tElementById(""txtTrongLuongGhepHD_BAN"").readOnly  = true;
        document.getElementById(""txtDvtHD_BAN"").readOnly  = true;
    }
    function Disable_HDMua() {
        document.getElementById(""txtSoHD_MUA"").readOnly  = true;
        document.getElementById(""txtIdHD_MUA"").readOnly  = true;
        document.getElementById(""txtTrongLuongHD_MUA"").readOnly  = true;
        document.getElementById(""txtTrongLuongGhepHD_MUA"").readOnly  = true;
        document.getElementById(""txtDvtHD_MUA"").readOnly  = true;
    }
...
#nullable restore
#line 297 "C:\Users\Sterben\Desktop\pmkd_intimex\Intimex_project\Views\Plans\AddPlans.cshtml"
                                                       Write(ViewBag.Sohd);
...
#nullable restore
#line 298 "C:\Users\Sterben\Desktop\pmkd_intimex\Intimex_project\Views\Plans\AddPlans.cshtml"
...
#nullable restore
#line 299 "C:\Users\Sterben\Desktop\pmkd_intimex\Intimex_project\Views\Plans\AddPlans.cshtml"
...
#nullable restore
#line 307 "C:\Users\Sterben\Desktop\pmkd_intimex\Intimex_project\Views\Plans\AddPlans.cshtml"
                                                       Write(ViewBag.Sohd);
...
#nullable restore
#line 308 "C:\Users\Sterben\Desktop\pmkd_intimex\Intimex_project\Views\Plans\AddPlans.cshtml"
                                                       Write(ViewBag.SystemRef);
...
#nullable restore
#line 309 "C:\Users\Sterben\Desktop\pmkd_intimex\Intimex_project\Views\Plans\AddPlans.cshtml"
                                                               Write(ViewBag.TrongLuong);
...
#nullable disable
    ...
    function txtSoHD_BAN_Click() {
        document.getElementById(""check_SelectedMuaBan"").value = ""BAN"";
    }
    function txtSoHD_MUA_Click() {
        document.getElementById(""check_SelectedMuaBan"").value = ""MUA"";
    }
    $(""#txtSoHD_BAN"").keyup(function (event) {
        if (event.keyCode === 13) {
            $(""#selected_HD"").modal('show');
            $(""#dataGrid_hdmb"").dxDataGrid(""refresh"");
        }
    });
    ...
    function Return_MuaBan() {
        var MuaBan = document.getElementById(""check_SelectedMuaBan"").value;
        return MuaBan;
    }
        ...
        if (data) {
            $.post('/Plans/Fill_data_plans', { 'SystemId': data.SystemId, 'Id_HDMB': IdHDMB }, function (item) {
                if (item == 1) {
                    ...
                    docu");
            WriteLiteral(@"ment.getElementById(""Trongluong"").value = item.Trongluong;
    ...
    function SelectedHDMB(selectedItems) {
        var data = selectedItems.selectedRowsData[0];
        var check_SelectedMuaBan = document.getElementById(""check_SelectedMuaBan"").value;
        if (data) {
            if (check_SelectedMuaBan == ""MUA"") {
                document.getElementById(""txtSoHD_MUA"").value = data.sohd;
                document.getElementById(""txtIdHD_MUA"").value = data.");
            WriteLiteral(@"systemref;
                document.getElementById(""txtTrongLuongHD_MUA"").value = data.TrongluongHD;
                document.getElementById(""txtTrongLuongGhepHD_MUA"").value = data.TrongLuongDuocGhep;
            } else {
                document.getElementById(""txtSoHD_BAN"").value = data.sohd;
                document.getElementById(""txtIdHD_BAN"").value = data.systemref;
                document.getElementById(""txtTrongLuongHD_BAN"").value = data.TrongluongHD;
                document.getElementById(""txtTrongLuongGhepHD_BAN"").value = data.TrongLuongDuocGhep;
            }
        }
    }
    ...
    function close_Popup_GetHDMB() {
        $(""#selected_HD"").modal('hide');
    }
