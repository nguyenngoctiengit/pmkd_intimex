...
var ResizableContainer = function(_InfernoComponent) {
    ...
    _proto.set_infoTextVisible = function(value) {
        var _this2 = this;
    ...
    _proto.set_isLargeDisplayMode = function(value) {
        var _this3 = this;
        this.setState((function(state) {
    ...
    _createClass(ResizableContainer, [{
        ...
        get: function() {
            var _this$props = this.props,
                restProps = (_this$props.contentTemplate, _this$props.pagerProps, _objectWithoutProperties(_this$props, ["contentTemplate", "pagerProps"]));
            return restProps
        }
    }]);
