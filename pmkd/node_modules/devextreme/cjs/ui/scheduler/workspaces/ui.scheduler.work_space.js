...
var SchedulerWorkSpace = function(_WidgetObserver) {
    ...
    _proto2.onDataSourceChanged = function() {};
    _proto2.preRenderAppointments = function(options) {
    ...
    _proto2.generateRenderOptions = function(isProvideVirtualCellsWidth) {
        var _this$_getToday;
        var groupCount = this._getGroupCount();
    ...
    _proto2.renderRGroupPanel = function() {
        var options = {
    ...
    _proto2.renderRHeaderPanel = function() {
    ...
    _proto2._attachGroupCountAttr = function() {
    ...
    _proto2._getGroupsForDateHeaderTemplate = function(templateIndex) {
    ...
    _proto2._toggleAllDayVisibility = function(isUpdateScrollable) {
    ...
    _proto2._getAllGroups = function() {
        var _this8 = this;
        var groupCount = this._getGroupCount();
    ...
    _proto2._getGroupsObjectFromGroupsArray = function(groupsArray) {
    ...
    _proto2._detachDragEvents = function(element) {
    ...
    _proto2._attachDragEvents = function(element) {
        var _this9 = this;
    ...
    _proto2._attachPointerEvents = function(element) {
        var _this10 = this;
        ...
        _events_engine.default.on(element, SCHEDULER_CELL_DXPOINTERDOWN_EVENT_NAME, DRAG_AND_DROP_SELECTOR, (function(e) {
            if ((0, _index2.isMouseEvent)(e) && 1 === e.which) {
                isPointerDown = true;
    ...
    _proto2._cleanTableWidths = function() {
    ...
    _proto2._getWorkSpaceWidth = function() {
        ...
        return this.cache.get("workspaceWidth", (function() {
            ...
            return (0, _position.getBoundingRect)(_this11.$element().get(0)).width - _this11.getTimePanelWidth()
        }))
    };
    ...
    _proto2._getVirtualCellOffset = function() {
    ...
    _proto2.getCoordinatesByDateInGroup = function(startDate, appointmentResources, inAllDayRow, groupIndex) {
        var _this12 = this;
        var result = [];
    ...
    _proto2.getMaxAllowedPosition = function(groupIndex) {
    ...
    _proto2.getMaxAllowedHorizontalPosition = function(groupIndex) {
    ...
    _proto2.getRMaxAllowedHorizontalPosition = function(groupIndex) {
        var _this15 = this;
    ...
    _proto2.getRMaxAllowedVerticalPosition = function(groupIndex) {
        var _this17 = this;
    ...
    _proto2._createDragBehaviorBase = function($element, getItemData, getItemSettings) {
        ...
        var element = this.$element();
        var attachGeneralEvents = function() {
            return _this20._attachDragEvents(element)
        };
        var detachGeneralEvents = function() {
    ...
    _proto2._getTimePanelCells = function() {
        return this.$element().find(".".concat(TIME_PANEL_CELL_CLASS))
    };
    _proto2._getRDateTableProps = function() {
        return {
            viewData: this.viewDataProvider.viewData,
            dataCellTemplate: this.option("dataCellTemplate"),
    ...
    _proto2._getTimeOffsetForStartViewDate = function() {
...
var createDragBehaviorConfig = function(container, isDefaultDraggingMode, dragBehavior, attachGeneralEvents, detachGeneralEvents, getDroppableCell, removeDroppableCellClass, getCellWidth, getItemData, getItemSettings, options) {
    var state = {
        dragElement: void 0,
        itemData: void 0
    };
    ...
    return {
        ...
        onDragStart: function(e) {
            ...
            if (state.itemData && !state.itemData.disabled) {
                ...
                if (!canceled) {
                    ...
                    event.data.initialPosition = (0, _translator.locate)((0, _renderer.default)(state.dragElement));
        ...
        onDragMove: function() {
            ...
            var draggableElement = (0, _translator.locate)((0, _renderer.default)(state.dragElement).parent());
