/**
 * DevExtreme (cjs/ui/pivot_grid/ui.pivot_grid.data_controller.js)
 * Version: 21.1.3
                            ...
                            (0, _uiPivot_grid.foreachTree)(headerItems, (function(items) {
                                ...
                                if (!item.children || 0 === item.children.length) {
                                    ...
                                    for (i = 0; i < cellDescriptions.length; i++) {
                                        ...
                                        var columnIsHidden = false === cellDescriptions[i].visible || isGrandTotal && -1 !== (0, _array.inArray)(i, options.hiddenGrandTotals) || isTotal && -1 !== (0, _array.inArray)(i, options.hiddenTotals) || isValue && -1 !== (0, _array.inArray)(i, options.hiddenValues);
                                        if (columnIsHidden) {
                                            continue
                                        }
                                        item.children.push({
