/**
 * DevExtreme (cjs/ui/data_grid/ui.data_grid.base.js)
 * Version: 21.1.3
...
var DataGrid = _ui.default.inherit({
    ...
    _init: function() {
        this.callBase();
        _uiData_grid.default.processModules(this, _uiData_grid.default);
        _uiData_grid.default.callModuleItemsMethod(this, "init")
    },
    _clean: _common.noop,
    _optionChanged: function(args) {
        _uiData_grid.default.callModuleItemsMethod(this, "optionChanged", [args]);
        if (!args.handled) {
            this.callBase(args)
        }
    },
    ...
    _dispose: function() {
        this.callBase();
        _uiData_grid.default.callModuleItemsMethod(this, "dispose")
    },
    isReady: function() {
    ...
    beginUpdate: function() {
        this.callBase();
        _uiData_grid.default.callModuleItemsMethod(this, "beginUpdate")
    },
    endUpdate: function() {
        _uiData_grid.default.callModuleItemsMethod(this, "endUpdate");
        this.callBase()
    },
