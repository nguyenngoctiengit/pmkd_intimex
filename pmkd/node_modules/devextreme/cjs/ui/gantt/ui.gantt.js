...
var Gantt = function(_Widget) {
    ...
    _proto._updateGanttRowHeights = function() {
    ...
    _proto._raiseResourceManagerDialogShowingAction = function(coreArgs) {
        var _this13 = this;
    ...
    _proto._createResourceManagerDialogShowingAction = function() {
    ...
    _proto._getTaskProgressTooltipContentTemplateFunc = function(taskTooltipContentTemplateOption) {
        var template = taskTooltipContentTemplateOption && this._getTemplate(taskTooltipContentTemplateOption);
    ...
    _proto._getTaskTimeTooltipContentTemplateFunc = function(taskTooltipContentTemplateOption) {
        var template = taskTooltipContentTemplateOption && this._getTemplate(taskTooltipContentTemplateOption);
        var createTemplateFunction = template && function(container, item, callback, posX) {
            template.render({
                model: item,
    ...
    _proto._getTaskContentTemplateFunc = function(taskContentTemplateOption) {
        var _this17 = this;
    ...
    _proto.exportToPdf = function(options) {
        var _fullOptions$docCreat, _window$jspdf$jsPDF, _window$jspdf, _fullOptions$format, _this19 = this;
        ...
        return new Promise((function(resolve) {
            ...
            var doc = null === (_this19$_ganttView = _this19._ganttView) || void 0 === _this19$_ganttView ? void 0 : _this19$_ganttView._ganttViewCore.exportToPdf(fullOptions);
            resolve(doc)
        }))
    };
