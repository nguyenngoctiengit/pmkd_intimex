...
export var viewFunction = viewModel => {
    var {
        ...
        direction: direction,
        forceUpdateHScrollbarLocation: forceUpdateHScrollbarLocation,
        forceUpdateVScrollbarLocation: forceUpdateVScrollbarLocation,
...
export class ScrollableSimulated extends InfernoComponent {
    ...
    wheelDirection(e) {
        switch (this.props.direction) {
            ...
            default:
                return null !== e && void 0 !== e && e.shiftKey ? DIRECTION_HORIZONTAL : DIRECTION_VERTICAL
        }
    }
    scrollToHome() {
        var distance = {
    ...
    get contentWidth() {
        ...
        var isOverflowHidden = "hidden" === getElementStyle("overflowX", this.contentRef.current);
        if (!isOverflowHidden) {
    ...
    get contentHeight() {
        ...
        var isOverflowHidden = "hidden" === getElementStyle("overflowY", this.contentRef.current);
        if (!isOverflowHidden) {
    ...
    get restAttributes() {
        var _this$props9 = this.props,
            restProps = _objectWithoutPropertiesLoose(_this$props9, ["aria", "bounceEnabled", "children", "classes", "contentTranslateOffsetChange", "direction", "disabled", "forceGeneratePockets", "height", "inertiaEnabled", "needScrollViewContentWrapper", "needScrollViewLoadPanel", "onBounce", "onEnd", "onKeyDown", "onPullDown", "onReachBottom", "onScroll", "onStart", "onStop", "onUpdated", "pullDownEnabled", "pulledDownText", "pullingDownText", "reachBottomEnabled", "reachBottomText", "refreshingText", "rtlEnabled", "scrollByContent", "scrollByThumb", "scrollLocationChange", "showScrollbar", "updateManually", "useKeyboard", "useNative", "visible", "width"]);
        return restProps
    }
    content() {
