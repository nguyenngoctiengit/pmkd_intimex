...
export class DataGrid extends InfernoWrapperComponent {
    ...
    callMethod(funcName, args) {
        var _this$instance2;
        var normalizedArgs = [...args].filter(arg => void 0 !== arg);
        return null === (_this$instance2 = this.instance) || void 0 === _this$instance2 ? void 0 : _this$instance2[funcName](...normalizedArgs)
    }
    ...
    createInstance() {
        ...
        var _this$props$filterVal = _extends({}, this.props, {
            ...
            restProps = _objectWithoutPropertiesLoose(_this$props$filterVal, ["onOptionChanged"]);
